...
file_output = open(datapath+'/Prediction_Test_onlyLSTM/LSTM_ALLchannels_model.pckl', 'wb') 
pickle.dump(model, file_output)
#file_output = open('saver/outputs/Prediction_Test_onlyLSTM/LSTM_ALLchannels_model.pckl', 'wb') 
#pickle.dump(model, file_output)
#
